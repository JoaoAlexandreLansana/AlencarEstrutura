        ...
        <asp:Panel ID="pnlManutencao" runat="server" GroupingText="Dados">
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td style="margin-left: 40px; height: 28px;">
                        <asp:Button ID="btnAdicionar" runat="server" CssClass="btn btn-info" OnClick="btnAdicionar_Click" Text="Listar" />
                        <asp:Button ID="btnRemover" runat="server" CssClass="btn btn-warning" OnClick="btnExcluir_Click" Text="Remover" Width="80px" />
                    </td>
                </tr>
                <tr>
