<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LSN010_ARMAZENAR_PRODUTO.aspx.cs" Inherits="AlencarEstrutura.LSN010_ARMAZENAR_PRODUTO" %>
        ...
        <asp:Panel ID="pnlTitulo" runat="server" HorizontalAlign="Center">
            <table style="width: 100%">
                <tr>
                    <td>
                        <h2>
                            <asp:Label ID="lbltitulo" runat="server" Text="Armazenar Produto"></asp:Label></h2>
                    </td>
                </tr>
            </table>
        </asp:Panel>
